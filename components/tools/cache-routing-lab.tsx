    ...
    <section className="not-prose my-8 rounded-2xl border border-border bg-card p-5 text-card-foreground shadow-sm sm:p-7" aria-labelledby={`${controlPrefix}-title`}>
      <div className="max-w-2xl">
        ...
        <p className="mt-3 text-sm leading-6 text-muted-foreground">
          Сравниваем только очередь и оставшийся prefill. Это синтетический пример, а не телеметрия,
          прогноз GPU или полная задержка запроса: здесь нет decode и сети.
        </p>
      </div>
