...
const toolsIndexCopy = {
  ...
  ru: {
    label: "Инструменты",
    title: "Небольшие проверки для работы с AI-платформой.",
    copy:
      "Инструменты работают в браузере: без внешних вызовов, аккаунтов и аналитики. Они дополняют хэндбук практическими проверками кеша, стоимости и готовности к выкатке.",
    open: "Открыть",
