...
Связанные материалы: [Prefix Cache](/ai-platform/components/prefix-cache), [audit-prompt-caching](/projects/audit-prompt-caching) и каноническая статья [«Короткий промпт ≠ дешёвый промпт: как оптимизация ломает prefix cache в LLM-агентах»](https://habr.com/ru/companies/bitrix/articles/1033822/).
