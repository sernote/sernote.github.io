...
После публикации этой версии в `main` ссылки будут вести на [стабильный запрос](https://github.com/sernote/sernote.github.io/blob/main/evidence/v3/agent-session-cache-reuse/step-stable.json), [запрос с перестановкой инструментов](https://github.com/sernote/sernote.github.io/blob/main/evidence/v3/agent-session-cache-reuse/step-drift.json) и [машинный снимок двух запусков](https://github.com/sernote/sernote.github.io/blob/main/evidence/v3/agent-session-cache-reuse/layout-linter-output.json). Машинный снимок сохраняет исходные команды, отдельный переносимый рецепт, ожидаемые и полученные коды завершения и оба JSON-результата.
