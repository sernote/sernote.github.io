...
Источники, applicability и ограничения проверены 22 июля 2026 года. Материал остаётся `draft + unreviewed`; `reviewCycleDays: 90` задаёт будущий цикл только после независимой профильной проверки и заполнения `reviewedAt`.
