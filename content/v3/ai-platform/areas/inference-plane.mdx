...
Источники и границы проверены 22 июля 2026 года. Запись остаётся `draft + unreviewed`; дата следующего review начнёт отсчитываться только после независимой предметной проверки.
