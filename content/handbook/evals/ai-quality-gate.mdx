...
A new summarization model can pass generic benchmarks and still fail product needs if it misses CRM-specific action items. The gate should include scenario examples and a task-level acceptance metric.
