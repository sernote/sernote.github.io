...
- Need the big picture -> [Production AI Platform Map](/handbook/platform-map).
- Need an executive maturity language -> [AI Platform Maturity Model](/handbook/maturity-model).
- Choosing MaaS, self-hosted or hybrid -> [MaaS vs Self-hosted](/handbook/strategy/maas-vs-self-hosted).
- Cost or latency is drifting -> [Inference Economics](/handbook/economics/inference-economics) and [Prefix Cache](/handbook/caching/prefix-cache).
- Quality moves after a model or prompt change -> [AI Quality Gate](/handbook/evals/ai-quality-gate).
- Debugging is blind -> [LLM Observability Checklist](/handbook/observability/llm-observability-checklist).
- Ownership is unclear -> [Ownership and Operating Model](/handbook/operating-model/ownership).
