...
<Callout title="Self-hosted / Hybrid" type="warning">
  Self-hosted / Hybrid is not just having GPUs. The level is mature only when
  gateway, eval gate, observability, fallback and capacity planning exist.
  Otherwise the organization gets a more expensive way to ship unknown
  regressions.
</Callout>
