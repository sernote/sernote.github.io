...
| Task 7 | 2 | 0 | About 20 minutes implementation and validation plus about 8 minutes review hardening; tracked separately | Implementation complete; review pending | Complete Talks and Projects indexes plus one source-backed detail exemplar each; review round 1 restored the official `ROИИ` evidence spelling and made publication dates a compile-time pair without changing Blog behavior. Independent review and browser/design QA remain with the root task. |
| Task 8 | 2 | 0 | Not started | Not started | — |
| Task 9 | 2 | 0 | Not started | Not started | — |
| Task 10 | 2 | 0 | Not started | Not started | — |
