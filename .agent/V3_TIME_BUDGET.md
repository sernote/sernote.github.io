...
| Task 5 | 2 | 0 | 17 minutes to implementation plus about 9 minutes of review hardening; tracked separately | Review-hardening checkpoint | Pure view models, four complete RU pages, localized mobile-dialog semantics, converged role and page copy, metadata, tests, static build, and landmark audit passed; autonomous browser/design review remains open. |
