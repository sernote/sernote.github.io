...
| Task 7 | 2 | 0 | About 20 minutes implementation and validation; tracked separately | Implementation complete; review pending | Complete Talks and Projects indexes plus one source-backed detail exemplar each; tests and static export pass, while independent review and browser/design QA remain with the root task. |
