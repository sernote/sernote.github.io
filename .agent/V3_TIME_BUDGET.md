...
| Task 5 | 2 | 0 | 17 minutes to implementation plus about 6 minutes of review hardening; tracked separately | Review-hardening checkpoint | Pure view models, four complete RU pages, localized mobile-dialog semantics, converged copy, metadata, tests, static build, and landmark audit passed; autonomous browser/design review remains open. |
